...
class SOCAuthManager {
    ...
    func signIn(withEmail email: String, password: String, completion: ((Result<SOCUser, SignInErrors>)->Void)?) {
    ...
    // MARK: TODO: Firebase sign up handler, add user to firestore */
    
    func signUp(withFullname fullname: String, withEmail email: String, withUsername username: String,
                    withPassword password: String, completion: ((Result<SOCUser, Error>)->Void)?) {
            ...
            auth.createUser(withEmail: email, password: password) { [weak self] authResult, error in
                ...
                SOCDatabaseRequest.shared.setUser(u) { () }
